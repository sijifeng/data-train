package com.season.kafka.prducer;
...
public class ordersInfoGenerator {
    ...
    private static final Logger logger = LoggerFactory.getLogger(ordersInfoGenerator.class);
    private int logsNumber = 1000;

    public void generate() {

        for(int i = 0; i <= logsNumber; i++) {
            System.out.println(randomOrderInfo());
